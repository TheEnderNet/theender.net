  ...
  <body style="background-color:black;background-image:url('../_resources/img/bg.png');background-repeat:no-repeat;background-position:center top;">
    ...
    <div class="row">
      ...
      <p style="color:white;font-family:'Arial'">
        ...
        I'm an extremely sarcastic 19 year old female from England. I do random stuff on the internet like host this
        ...
        I also own and operate most of the servers for <i>The Dark IRC Co.</i> Network, it's twinned with the PC-Logix IRC Network owned by Michiyo, you can get on to it by connecting to either
        thedarkirc.co using standard IRC ports or by directly connecting to this address, take your pick.<br><br>
    ...
    <div class="row">
      ...
      <p style="color:white;font-family:'Arial'">
        ...
        via IRC on either EsperNet ( usually as "Lizzy" in #oc or #vifino ) or TheDarkIRCCo. ( usually as "Lizzy" ),<br>
